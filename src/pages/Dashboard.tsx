    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-muted/20 to-accent/10">
      <div className={`container max-w-6xl mx-auto ${isMobile ? 'p-3' : 'p-6'} space-y-6 md:space-y-8`}>
        ...
        <div className={`grid gap-4 ${isMobile ? 'grid-cols-1' : 'md:grid-cols-2 lg:grid-cols-4'}`}>
          {/* Main Documents/Assignments Card */}
          <Tooltip>
            <TooltipTrigger asChild>
              <Card 
                ...
                onClick={() => navigate(isOfficeMode ? "/work/notes" : "/work/assignments")}
              >
                <CardHeader className="py-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <CardDescription>
                        {isOfficeMode 
                          ? 'View and manage all your documents and files'
                          : 'View and manage all your IB assignments'}
                      </CardDescription>
                    </div>
                  </div>
                </CardHeader>
        ...
        {assignments.length > 0 && (
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Button variant="ghost" size="sm" onClick={() => navigate("/work/assignments")}>
                View All
              </Button>
            </div>
