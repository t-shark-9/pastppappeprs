 ...
 * Includes title page and bibliography for IB assignments (IA, EE, TOK)
 */
export function generateDraftFromOutline(
  ...
  // Determine if this is an IB assignment that needs special formatting
  const isIBAssignment = ['ia', 'ee', 'tok'].includes(taskType || '');
  
  let html = '';
  
  // Add title page for IB assignments
  ...
  // Add bibliography for IB assignments
