...
export { CollaboraEditor } from './CollaboraEditor';
...
export type EditorType = 'blocknote' | 'outline' | 'collabora' | 'onlyoffice';
...
export const EDITOR_INFO: Record<EditorType, {
  ...
  collabora: {
    ...
    description: 'LibreOffice in the browser - full office suite',
    icon: '📘',
    bestFor: ['Word documents', 'Complex formatting', 'MS Office compatibility'],
  },
  onlyoffice: {
    name: 'OnlyOffice',
    description: 'Online document editor with excellent Office compatibility',
    icon: '📙',
    bestFor: ['Professional documents', 'Team collaboration', 'Office formats'],
  },
};
